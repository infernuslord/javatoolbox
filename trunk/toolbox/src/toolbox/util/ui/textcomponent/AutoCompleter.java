...
public abstract class AutoCompleter{
    ...
    private static final Logger logger_ = Logger.getLogger(AutoCompleter.class);
    ...
    public AutoCompleter(JTextComponent comp){
        ...
        popup.addPopupMenuListener(new PopupMenuListener() {
            ...
            public void popupMenuWillBecomeInvisible(PopupMenuEvent e) {
                textComp.unregisterKeyboardAction(
    ...
    static Action acceptAction = new AbstractAction() {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            completer.acceptedListItem(
                (String) completer.list.getSelectedValue());
        }
    }; 
