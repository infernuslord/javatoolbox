...
public class StackLayout2 implements LayoutManager
{
	...
	public StackLayout2(int orientation)
	{
	...
	between components. */
	public StackLayout2(int orientation, int margin)
	{
		this.orientation = orientation;
		this.margin = margin;
	}
	...
	public void layoutContainer(Container parent)
	{
		...
		int W = sz.width - in.left - in.right,
			...
			int L = (orientation == HORIZONTAL ? W : H),
		...
		// Second pass: layout the components.
			int r = (orientation == HORIZONTAL ? in.left : in.top),
		// running pos.
