 ...
 * seconds of the movie that has been transcoded.
 */
public class FFMpegProgressOutputStream extends FilterOutputStream {
    ...
    /**
     * Token to find in the stream.
     */
    private static final String TOKEN_TIME = " time=";
    
    /**
     * State in when searching for the token.
     */
    private static final int STATE_SCAN_TOKEN = 0;
    
    /**
     * State in when the token has been found.
     */
    private static final int STATE_FOUND_TOKEN = 1;
