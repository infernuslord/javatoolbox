 ...
 * DOCUMENTATION REMAINS WITH THE USER. A vertical layout manager similar to
 * java.awt.FlowLayout. Like FlowLayout components do not expand to fill
 * available space except when the horizontal alignment is <code>BOTH</code>
 * in which case components are stretched horizontally. Unlike FlowLayout,
 * components will not wrap to form another column if there isn't enough space
 * vertically. VerticalLayout can optionally anchor components to the top or
 * bottom of the display area or center them between the top and bottom.
 * 
...
public class VerticalLayout implements LayoutManager {
     ...
     *        <code>TOP, BOTTOM, CENTER</code> indicating where the components
