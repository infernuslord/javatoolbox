...
public class Assert
{
    ...
    private static String DEFAULT_MSG = "";
     ...
     * @param allowedTolerance  The allowed difference between aDoubleA and aDoubleB
     * @param anErrorMsg          A text message used in the construction of an exception
     *                            when the two numbers differ beyond allowedTolerance.
     *
     * @exception AssertionException  Raised with anErrorMsg when the condition fails.
     */
    public static void equals(double aDoubleA, double aDoubleB, double allowedTolerance, String anErrorMsg)
        throws AssertionException
    {

        if (Math.abs(aDoubleA - aDoubleB) > allowedTolerance)
        {
            raiseAssertionException(anErrorMsg + " (Expected <" + aDoubleA + "> but was <" + aDoubleB + ">)");
        }
    }
     ...
     * @param allowedTolerance  The allowed difference between aFloatA and aFloatB
     * @param anErrorMsg  A text message used in the construction of an exception
     *                    when the two numbers differ beyond allowedTolerance.
     * @exception AssertionException  Raised with anErrorMsg when the condition fails.
     */
    public static void equals(float aFloatA, float aFloatB, float allowedTolerance, String anErrorMsg)
        throws AssertionException
    {

        if (Math.abs(aFloatA - aFloatB) > allowedTolerance)
        {
            raiseAssertionException(anErrorMsg + " (Expected <" + aFloatA + "> but was <" + aFloatB + ">)");
        }
    }

    /**
     * Assert that two objects are <code>equal</code>.
     ...
     */
    public static void equals(long aLongA, long aLongB, String anErrorMsg)
        throws AssertionException
    {

        if (aLongA != aLongB)
        {
            raiseAssertionException(anErrorMsg + " (Expected <" + aLongA + "> but was <" + aLongB + ">)");
        }
    }
     ...
     * @exception AssertionException  Raised when the anObjectA not equal to anObjectB
     */
     ...
     * @exception AssertionException  Raised when the anObjectA not equal to anObjectB
     */
    public static void equals(Object anObjectA,    Object anObjectB, String anErrorMsg)
        throws AssertionException
    {

        if (!anObjectA.equals(anObjectB))
        {
            raiseAssertionException(anErrorMsg + " (Expected <" + anObjectA + "> but was <" + anObjectB + ">)");
        }
    }
     ...
     * @param anErrorMsg  A text message used in the construction of an exception
     *                         when anExpressionResult is true.
     * @exception            AssertionException  raised with message when aBool is true
     */
     ...
     * @param anErrorMsg              A text message used in the construction of an exception
     *                                when anExpressionResult is false.
     * @exception  AssertionException  raised with message when aBool is false
     */
