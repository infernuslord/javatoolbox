...
/**
 * Pops up a font chooser dialog box and allows a user to select the font for a 
 * component.
 */
public class SetFontAction extends AbstractAction
{
     ...
     * 
     * @param component Component to set the font for.
     */
    ...
    /**
     * Pops up a font chooser dialog and sets the font for the component to
     * the selected font.
     * 
