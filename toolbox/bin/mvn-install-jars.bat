...
:call mvn %sa% install:install-file -Dfile=%LIB%\commons-io.jar       -DartifactId=commons-io       -DgroupId=toolbox -Dversion=SNAPSHOT -Dpackaging=jar -DgeneratePom=true
...
call mvn %sa% install:install-file -Dfile=%LIB%\jemmy.jar            -DartifactId=jemmy            -DgroupId=toolbox -Dversion=SNAPSHOT -Dpackaging=jar -DgeneratePom=true
...
call mvn %sa% install:install-file -Dfile=%LIB%\jsap.jar             -DartifactId=jsap             -DgroupId=toolbox -Dversion=SNAPSHOT -Dpackaging=jar -DgeneratePom=true
...
:call mvn %sa% install:install-file -Dfile=%LIB%\jung.jar             -DartifactId=jung             -DgroupId=toolbox -Dversion=SNAPSHOT -Dpackaging=jar -DgeneratePom=true
...
call mvn %sa% install:install-file -Dfile=%LIB%\qdox.jar             -DartifactId=qdox             -DgroupId=toolbox -Dversion=SNAPSHOT -Dpackaging=jar -DgeneratePom=true
