...
public interface Sync
{
	 ...
	 * corresponding release should be performed. Conversely, a normal return
	 * guarantees that the acquire was successful.
	 * 
	 ...
	 * <p>
	 * 
	 * @param msecs the number of milleseconds to wait. An argument less than
	 *            or equal to zero means not to wait at all. However, this may
