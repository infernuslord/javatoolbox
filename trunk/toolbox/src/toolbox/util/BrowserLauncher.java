            ...
            case MRJ_2_0:
                try
                {
                    ...
                    Field autoGenerateReturnIDField = 
                        appleEventClass.getDeclaredField(
        ...
        switch (jvm)
        {
            case MRJ_2_0:
                try
                {
                    ...
                    Object aeTarget = 
                        aeTargetConstructor.newInstance(
                    ...
                    // we call locateBrowser(), we'll get the same AppleEvent,
                    // to whichwe'll already have added the relevant parameter. 
            ...
            case MRJ_2_1:
                ...
                try
                {
                    systemFolder = (File) 
                        findFolder.invoke(
                            null, new Object[]{kSystemFolderType});
                }
        ...
        switch (jvm)
        {
            case MRJ_2_0:
                ...
                try
                {
                    ...
                    putParameter.invoke(
                        browser, new Object[]{ keyDirectObject, aeDesc});
