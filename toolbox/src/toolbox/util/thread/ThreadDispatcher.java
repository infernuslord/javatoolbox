...
public class ThreadDispatcher extends AbstractDispatcher
{
    ...
    /**
     * Constructs a new thread dispatcher using the given threading strategy.
     *
     * @param strategy Threading strategy that services requests.
     */
    ...
    /**
     * Dispatches the request in an alternate thread using the supplied
