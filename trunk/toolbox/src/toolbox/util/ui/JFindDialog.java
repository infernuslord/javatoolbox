...
class JFindDialog extends JDialog
{
	...
	/**
	 * Kicks of text search. A successful search will result in the 
	 * found text being selected and visible in the text component's 
	 * viewport. A failure will be indicated on the status bar in the
	 * find dialog.
	 */
