...
/**
 * Unit test for {@link toolbox.util.file.activity.FileDeletedActivity}.
 */
public class FileDeletedActivityTest extends TestCase {

    private static final Logger logger_ = 
        Logger.getLogger(FileDeletedActivityTest.class);
    ...
    public static void main(String[] args) {
        TestRunner.run(FileDeletedActivityTest.class);
    }
