...
public interface Sync
{
     ...
     * The msecs bound cannot be guaranteed to be a precise upper bound on 
     * wait time in Java. Implementations generally can only attempt to return 
     * as soon as possible after the specified bound. Also, timers in Java do 
     * not stop during garbage collection, so timeouts can occur just because 
     * a GC intervened. So, msecs arguments should be used in a coarse-grained 
     ...
     * unintended ways. For example, deadlocks may be encountered when called 
