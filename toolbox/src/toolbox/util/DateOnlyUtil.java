 ...
 * </pre>
 */
public final class DateOnlyUtil
{
    //--------------------------------------------------------------------------
    // Constructors
    //--------------------------------------------------------------------------
     ...
     * @return Next occurring date of the given day.
     */
    ...
    /**
     * Gets the previous occurrence of the given day of the week relative to
     * today. Answers the question: What was the date of last Wednesday?
     *
     * @param day Calendar.MONDAY, TUE, ...
     * @return Previous occurring date of the given day.
     */
    ...
    /**
     * Gets the previous occurrence of the given day of the week starting from 
     * the the given date.
     *
     ...
     *
     * @param d1 The lesser of the two dates.
     * @param d2 The greater of the two dates.
    ...
    public static int getDifferenceInDays(final Date d1, final Date d2)
    {
        ...
        Date d1Zero = zeroTime(new Date(d1.getTime()));
        Date d2Zero = zeroTime(new Date(d2.getTime()));
        
        if (d1Zero.after(d2Zero)) {
        	Date temp = d1Zero;
        	d1Zero = d2Zero;
        	d2Zero = temp;
        }
     ...
     *
     * @param before The lesser of the two dates.
    ...
    /**
     * Determines if a date is between a given date range inclusive of the
